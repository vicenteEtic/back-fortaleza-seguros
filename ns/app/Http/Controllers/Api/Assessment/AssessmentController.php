...
use App\Http\Requests\AssementRequest;
...
class AssessmentController extends Controller
{
    ...
    {
        try {
            $response = Assessment::with(['product_risks', 'entity', 'user', 'beneficialOwners'])->orderBy('id', 'desc')->paginate(50);
    ...
    public function pep()
    {
        try {
            ...
            $response = Assessment::where('pep', '1')
                ->with('entity')
                ->orderBy('id', 'asc') // Altera para ascendente
                ->get();
            ...
            foreach ($response as $item) {
                ...
                $beneficialOwners = BeneficialOwner::where('pep', '1')
                    ...
                    ->orderBy('name', 'asc') // Ordenar Beneficial Owners por nome
                    ->get();
            ...
            // Ordenar os dados por nome em ordem ascendente
