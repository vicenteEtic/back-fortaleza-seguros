...
namespace App\Http\Controllers\Api\IdentificationCapacity;
...
class IdentificationCapacityController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            $data = IndicatorType::where('fk_indicator', 1)->orderBy('description', 'asc')->get();
